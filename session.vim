...
let s:l = 37 - ((16 * winheight(0) + 10) / 21)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 61 - ((14 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 62 - ((27 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
wincmd w
argglobal
edit templates/flatpages/about.html
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> '[ <Plug>SIG_PrevLineByAlpha
nmap <buffer> '] <Plug>SIG_NextLineByAlpha
...
152
normal! zo
let s:l = 161 - ((31 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
161
...
exe '1resize ' . ((&lines * 32 + 34) / 68)
exe '2resize ' . ((&lines * 32 + 34) / 68)
tabedit templates/carousel.html
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
